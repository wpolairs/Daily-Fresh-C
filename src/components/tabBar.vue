<template>
    <van-tabbar route :fixed='true'>
      ...
      <van-tabbar-item replace to="/classify" icon="qr-invalid">分类</van-tabbar-item>
      <van-tabbar-item replace to="/shoping" icon="shopping-cart-o"
      :badge="count"
      id="shopCar">购物车</van-tabbar-item>
